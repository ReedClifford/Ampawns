	...
	<section>
		<header>
			...
			<nav class="navbar3">
				...
				<ul class="nav3">
					...
					<li class="nav-item3">
						<a href="applicants.php" class="navlink2"><button class="navbtn3 active2">Applicants</button></a>
					</li>
					<li class="nav-item3">
		...
		<div class="container">
			...
			<table>
				<tr>
					...
					<th>Email</th>
					<th>Contact #</th>
					<th>Requested Zoom Date</th>
					<th>Requested Zoom Time</th>
					<th>Action</th>
				...
				$sql = "SELECT id, name, adrs, email, cnumber, zdate, ztime from registration where status='applicant' order by zdate, ztime";
				...
				if ($result->num_rows > 0) {
				    ...
				    <td>" . $row["zdate"] . "</td>
				    <td>" . $row["ztime"] . "</td>
				    <td><a href='delete.php?GetID=$idd'><input type='submit' name='delete' value='DELETE'/></td>
	                </tr>";
					}
					echo "</table>";
				} else {
		...
		<div class="formdiv">
			...
			<form class="form" action="test3.php" method="POST">
				<div class="text">
					<h4>Confirm for interview:</h4>
				</div>

				<input type="text" name="id" placeholder="Enter Registree ID" />
				<input type="date" name="zdate" placeholder="Enter selected date" />
				<input type="time" name="ztime" placeholder="Enter selected time" />
