		...
		<header>
			...
			<nav class="navbar3">
				...
				<ul class="nav3">
					...
					<li class="nav-item3">
						<a href="4interview.php" class="navlink2"> <button class="navbtn3 active2">Interview</button></a>
					</li>
					<li class="nav-item3">
		...
		<div class="container">
			...
			<table>
				<tr>
					...
					<th>Email</th>
					<th>Contact #</th>
					<th>Scheduled Zoom Date</th>
					<th>Scheduleed Zoom Time</th>
					<th>Action</th>
				...
				$sql = "SELECT id, name, adrs, email, cnumber, zdate, ztime from registration where status='for interview' order by zdate, ztime";
				...
				if ($result->num_rows > 0) {
				    ...
				    <td>" . $row["zdate"] . "</td>
				    <td>" . $row["ztime"] . "</td>
				     <td><a href='delete2.php?GetID=$idd'><input type='submit' name='delete' value='DELETE'/></td>
	                </tr>";
					}
					echo "</table>";
				} else {
			...
			<div class = "formdiv">
				<br>
				<form class = "form" action="test4.php" method="POST">
					<div class="text">
					<h5>Confirm for clinic visit:</h5>

					</div>
					
					<input type="text" name="id" placeholder="Enter Registree ID" />
					<input type="date" name="cvdate" placeholder="Enter selected date" />
					<input type="time" name="cvtime" placeholder="Enter selected time" />
